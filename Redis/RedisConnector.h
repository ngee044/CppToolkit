...
namespace Redis
{
	...
	public:
		...
		auto expire(const std::string& key, std::uint32_t ttl_sec) -> std::tuple<bool, std::optional<std::string>>;
		auto ttl(const std::string& key) -> std::tuple<int64_t, std::optional<std::string>>;
		...
		auto db_size() -> std::tuple<int64_t, std::optional<std::string>>;
